...
class Life_Settings {
    ...
    cops_online_min = 7; //minimum cops online for robbing a bank
    ...
    gang_price = 350000; //Price for creating a gang, remember they are persistent so keep it reasonable to avoid millions of gangs.
